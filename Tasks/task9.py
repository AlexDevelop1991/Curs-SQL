...
# SELECT DISTINCT first_name, last_name, salary FROM employees WHERE first_name LIKE '_a%'
# INTERSECT
...
# SELECT location_id, postal_code, city FROM locations WHERE country_id IN
